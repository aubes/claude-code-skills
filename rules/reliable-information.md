Scope: **factual accuracy** when stating technical information (verifying versions, APIs, flags, URLs, EOL dates; flagging uncertainty). Intellectual posture (opinion vs trade-off, alternatives) and markdown citation formatting are out of scope.
...
- Never invent URLs, package names, or function signatures
